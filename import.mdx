...
Your bookmarks appear in collections that match the original folder structure. Thumbnails, search filters, and [web archive](/web-archive) copies are processed in the background — you'll get an email when everything is ready.
