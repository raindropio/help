...
<Note>If the collection owner has a [Pro plan](https://raindrop.io/pro/buy), every member gains access to full-text search on that collection — even without their own Pro subscription.</Note>
