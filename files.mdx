...
<Tabs sync={false}>
    <Tab title="Web & Desktop">
        <Steps>
            ...
            <Step>
                *Optionally:* you can also drag files from your desktop straight into a collection — upload starts immediately.
            </Step>
        </Steps>
    </Tab>
...
See [Limits](/limitations) for a full plan comparison.
