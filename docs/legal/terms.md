...
You can cancel your service subscription at any time by clicking on the [Subscription link](https://app.raindrop.io/settings/pro) in the settings. The Subscription screen provides a `Change subscription` link where you can cancel your subscription.
