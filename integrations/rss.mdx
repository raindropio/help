...
Browse [ready-made applets](https://ifttt.com/connect/raindrop/rss) or [create your own](https://ifttt.com/create) — including multi-step workflows. Learn how such [integrations work](/integrations/ifttt)
